...
class WearablesService:
    ...
    async def store_health_metrics(patient_id: str, device_id: str, metrics: HealthMetrics) -> Dict[str, Any]:
        ...
        document = {
            ...
            "sleep_deep_hours": metrics.sleep_deep_hours,
            "sleep_core_hours": metrics.sleep_core_hours,
            "sleep_rem_hours": metrics.sleep_rem_hours,
            "sleep_light_hours": metrics.sleep_light_hours,
