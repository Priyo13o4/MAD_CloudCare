...
class HealthMetrics(BaseModel):
    ...
    sleep_deep_hours: Optional[float] = Field(None, ge=0, le=24, description="Deep sleep duration in hours")
    sleep_core_hours: Optional[float] = Field(None, ge=0, le=24, description="Core sleep duration in hours")
    sleep_rem_hours: Optional[float] = Field(None, ge=0, le=24, description="REM sleep duration in hours")
    sleep_light_hours: Optional[float] = Field(None, ge=0, le=24, description="Light sleep duration in hours")
